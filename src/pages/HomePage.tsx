...
// Parts Inventory Slider Settings – fully responsive for all screen widths
const partsInventorySettings = {
  ...
  responsive: [
    ...
    { breakpoint: 480, settings: { slidesToShow: 1, slidesToScroll: 1 } },  // extra small
    { breakpoint: 360, settings: { slidesToShow: 1, slidesToScroll: 1 } },  // very small
  ],
};

// Parts Categories Data (unchanged)
...
const HomePage: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Visual Impact Section – ultra-responsive with fluid typography and adaptive image grid */}
      <section className="py-12 sm:py-16 md:py-24 lg:py-32 bg-gradient-to-br from-slate-50 to-indigo-50/60 relative overflow-hidden">
        ...
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12 lg:gap-16 items-center">
            ...
            {/* Right: Image Grid – responsive 2 columns with fluid heights */}
            <motion.div
              initial={{ opacity: 0, x: 30 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
      ...
      {/* Core Services – responsive grid and card sizing */}
      ...
      {/* Parts Inventory – fully responsive slider and CTA */}
      <section className="py-12 sm:py-16 md:py-24 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
        ...
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          >
            <p className="text-xs sm:text-sm md:text-base text-gray-600 mb-3 sm:mb-4 md:mb-6 max-w-2xl mx-auto px-2 sm:px-4">
